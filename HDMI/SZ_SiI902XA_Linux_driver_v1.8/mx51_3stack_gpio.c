...
static struct mxc_iomux_pin_cfg __initdata mxc_iomux_pins[] = {
	...
	{ //CSI1_nOE
	 MX51_PIN_EIM_LBA, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_SRE_SLOW | PAD_CTL_DRV_LOW  | PAD_CTL_PKE_ENABLE),
...
//#ifdef CONFIG_I2C_MXC_SELECT1
#if 1
	{ //add by yejj, for PMIC13892 I2C1 SDATA
	 MX51_PIN_CSPI1_MOSI, IOMUX_CONFIG_ALT1 | IOMUX_CONFIG_SION,
	...
	{ //add by yejj, for PMIC13892 I2C1 SCLOCK
	 MX51_PIN_CSPI1_SCLK, IOMUX_CONFIG_ALT1 | IOMUX_CONFIG_SION,
	 (PAD_CTL_SRE_FAST | PAD_CTL_ODE_OPENDRAIN_ENABLE |
	 PAD_CTL_DRV_HIGH | PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE |
     PAD_CTL_DRV_VOT_LOW | PAD_CTL_DDR_INPUT_CMOS),
	 ...
	 /*
	{
	 ...
	 (PAD_CTL_HYS_ENABLE | PAD_CTL_PKE_ENABLE |PAD_CTL_22K_PU |PAD_CTL_PKE_ENABLE |
		 PAD_CTL_ODE_OPENDRAIN_ENABLE | PAD_CTL_DRV_MAX |
		 PAD_CTL_SRE_FAST),
	 }, */
	 {
...
/*
	 ...
	 */
	 ...
	 {			
	 MX51_PIN_USBH1_CLK, (IOMUX_CONFIG_ALT5 | IOMUX_CONFIG_SION),
	 (PAD_CTL_SRE_FAST | PAD_CTL_ODE_OPENDRAIN_ENABLE | PAD_CTL_DRV_HIGH |
	  PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE),
	 MUX_IN_I2C2_IPP_SCL_IN_SELECT_INPUT,
	 INPUT_CTL_PATH3,
	...
	{			/* AUD3_FS */
	 ...
	 {			/* gary modify 20100630*/
	 MX51_PIN_EIM_CRE, IOMUX_CONFIG_ALT1,
...
#if defined(CONFIG_FB_MXC_LCD1) || defined(CONFIG_FB_MXC_LCD1_LCD2)
	{
	 MX51_PIN_DISP1_DAT0, IOMUX_CONFIG_ALT0,
	 (PAD_CTL_PUE_KEEPER | PAD_CTL_DRV_HIGH | PAD_CTL_SRE_FAST),
	 },
	{
	 ...
	 },
	{
	 ...
	 (PAD_CTL_HYS_NONE | PAD_CTL_PKE_ENABLE | PAD_CTL_PUE_KEEPER |
	  PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_SRE_FAST),
	 },
	{
...
#endif
#if defined(CONFIG_FB_MXC_LCD2) || defined(CONFIG_FB_MXC_LCD1_LCD2)
	{
	...
	},
	{
	 ...
	 (PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_ODE_OPENDRAIN_ENABLE | 
	  PAD_CTL_DRV_HIGH | PAD_CTL_SRE_FAST | PAD_CTL_HYS_ENABLE),
	},
	{
	 MX51_PIN_DI2_PIN4, IOMUX_CONFIG_ALT0,
	 (PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_DRV_HIGH | 
	  PAD_CTL_SRE_FAST | PAD_CTL_HYS_ENABLE),
	},
	{
	...
	/*
	{
	 MX51_PIN_DI2_PIN4, IOMUX_CONFIG_ALT4,
	 (PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_DRV_HIGH |
	  PAD_CTL_SRE_FAST | PAD_CTL_HYS_ENABLE),
	},
	
	{
	 MX51_PIN_DISPB2_SER_DIO, IOMUX_CONFIG_ALT4,
	 (PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_DRV_HIGH |
	  PAD_CTL_SRE_FAST),
	 },
	 */
	...
	/* USBH1_PHY_EN */
	{
	 MX51_PIN_EIM_EB3, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_PUE_KEEPER |
	  PAD_CTL_PKE_ENABLE | PAD_CTL_HYS_NONE),
	},
	/* USBH1_PHY_RST */
	{
	 MX51_PIN_EIM_CS0, IOMUX_CONFIG_ALT1,
	...
	/* USBH2_DATA3 */	
	{
	 ...
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_100K_PU |
	  PAD_CTL_ODE_OPENDRAIN_NONE | PAD_CTL_PUE_KEEPER |
	  PAD_CTL_PKE_ENABLE | PAD_CTL_HYS_ENABLE),
	},
	/* USBH2_DATA4 */
	{
	...
	/* USBH2_PWR_EN */
	{
	 MX51_PIN_EIM_CS1, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_PKE_ENABLE),
	},
	/* USBH2_OC */
	{
	 MX51_PIN_GPIO1_6, IOMUX_CONFIG_ALT0,
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_ODE_OPENDRAIN_NONE |
      PAD_CTL_100K_PU | PAD_CTL_PUE_KEEPER | PAD_CTL_PKE_ENABLE |
	  PAD_CTL_HYS_ENABLE),
	},
	...
	/* USBH2_PHY_RST */
	{
	 MX51_PIN_EIM_DTACK, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_PKE_ENABLE),
	},
	/* USBOTG_OC */
	{
	 MX51_PIN_EIM_CS3, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_SRE_SLOW | PAD_CTL_DRV_LOW | PAD_CTL_ODE_OPENDRAIN_NONE |
	  PAD_CTL_PUE_KEEPER | PAD_CTL_PKE_ENABLE | PAD_CTL_HYS_ENABLE),
	},
	/* USBOTG_PWR_EN */
	{
	 MX51_PIN_EIM_CS4, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_SRE_SLOW | PAD_CTL_ODE_OPENDRAIN_NONE | PAD_CTL_DRV_MEDIUM |
	  PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH | 
	 ...
	 */
	{
	 ...
	 (PAD_CTL_DRV_MAX | PAD_CTL_HYS_ENABLE | PAD_CTL_PUE_PULL |
	  PAD_CTL_22K_PU | PAD_CTL_PKE_ENABLE | PAD_CTL_SRE_FAST),
	 },
	{
...
//#if defined(CONFIG_SND_SOC_IMX_3STACK_WM8731) || defined(CONFIG_SND_SOC_IMX_3STACK_WM8731_MODULE)
	/* AUD6_RXC */
	{
	 MX51_PIN_EIM_D27, IOMUX_CONFIG_ALT5,
	 (PAD_CTL_SRE_FAST | PAD_CTL_ODE_OPENDRAIN_ENABLE |
	  PAD_CTL_DRV_HIGH | PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE |
	  PAD_CTL_DRV_VOT_LOW | PAD_CTL_DDR_INPUT_CMOS),
	...
	/* AUD6_RXFS */
	{
	 MX51_PIN_EIM_D24, IOMUX_CONFIG_ALT5,
	 (PAD_CTL_SRE_FAST | PAD_CTL_ODE_OPENDRAIN_ENABLE |
	  PAD_CTL_DRV_HIGH | PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE |
	  PAD_CTL_DRV_VOT_LOW | PAD_CTL_DDR_INPUT_CMOS),
	...
	/* AUD6_TXC */
	{
	 ...
	 (PAD_CTL_SRE_SLOW | PAD_CTL_ODE_OPENDRAIN_ENABLE |
	  PAD_CTL_DRV_HIGH | PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE |
	  PAD_CTL_DRV_VOT_LOW | PAD_CTL_DDR_INPUT_CMOS),
...
#endif	 
//#endif
#if 0 //defined (CONFIG_PHY_RTL8201)
	/*TX_ER */
	{
	 MX51_PIN_DI_GP3, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	/*CRS */
	{
	 MX51_PIN_DI2_PIN4, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_CRS_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*MDC */
	{
	 MX51_PIN_DI2_PIN2, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	/*MDIO */
	{
	 MX51_PIN_DI2_PIN3, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_ODE_OPENDRAIN_ENABLE | 
	  PAD_CTL_22K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_MDI_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*RDATA[1] */
	{
	 MX51_PIN_DI2_DISP_CLK, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RDATA_1_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*RDATA[2] */
	{
	 MX51_PIN_DI_GP4, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RDATA_2_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*RDATA[3] */
	{
	 MX51_PIN_DISP2_DAT0, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RDATA_3_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*RX_ER */
	{
	 MX51_PIN_DISP2_DAT1, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RX_ER_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*TDATA[1] */
	{
	 MX51_PIN_DISP2_DAT6, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	/*TDATA[2] */
	{
	 MX51_PIN_DISP2_DAT7, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	/*TDATA[3] */
	{
	 MX51_PIN_DISP2_DAT8, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	/*TX_EN */
	{
	 MX51_PIN_DISP2_DAT9, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	/*COL */
	{
	 MX51_PIN_DISP2_DAT10, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_COL_SELECT_INPUT, INPUT_CTL_PATH1
	},
	/*RX_CLK */
	{
	 MX51_PIN_DISP2_DAT11, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RX_CLK_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*RX_DV */
	{
	 MX51_PIN_DISP2_DAT12, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RX_DV_SELECT_INPUT, INPUT_CTL_PATH1
	},
	/*TX_CLK */
	{
	 MX51_PIN_DISP2_DAT13, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_TX_CLK_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*RDATA[0] */
	{
	 MX51_PIN_DISP2_DAT14, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_HYS_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	 MUX_IN_FEC_FEC_RDATA_0_SELECT_INPUT, INPUT_CTL_PATH1,
	},
	/*TDATA[0] */
	{
	 MX51_PIN_DISP2_DAT15, IOMUX_CONFIG_ALT2,
	 (PAD_CTL_100K_PU | PAD_CTL_DRV_HIGH | PAD_CTL_DRV_VOT_HIGH),
	},
	{
	 MX51_PIN_EIM_CS5, IOMUX_CONFIG_GPIO,
	 (PAD_CTL_SRE_FAST | PAD_CTL_DRV_HIGH | PAD_CTL_100K_PU |
	  PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_DRV_VOT_HIGH),
	},
	{
...
#endif
#if 1//(defined(CONFIG_HDMI_Sii902xA))&&!(defined(CONFIG_PHY_RTL8201))
	{
	 MX51_PIN_EIM_OE, IOMUX_CONFIG_ALT1,
	 (PAD_CTL_PKE_ENABLE | PAD_CTL_PUE_KEEPER | PAD_CTL_DRV_HIGH | PAD_CTL_SRE_FAST),
	},/*
	{
	 MX51_PIN_DI2_PIN4, IOMUX_CONFIG_GPIO,
	 0,
...
static int __initdata enable_ata = { 1 };
#else
...
void __init mx51_3stack_io_init(void)
{
	...
	/* CSI1_nOE */
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_LBA), "eim_lba");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_LBA), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_LBA), 1);
	...
	//gpio_direction_input(IOMUX_TO_GPIO(MX51_PIN_GPIO1_7));	/* SD2 WP */
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_GPIO1_8), "gpio1_8");
	gpio_direction_input(IOMUX_TO_GPIO(MX51_PIN_GPIO1_8));	/* SD2 CD */

	/* FEC related gpio */
	#if 0//defined(CONFIG_PHY_RTL8201)
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_OE), "eim_oe");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_OE), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_OE), 0);

	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_CS5), "eim_cs5");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_CS5), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_CS5), 0);
	msleep(10);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_CS5), 1);
	msleep(100);
	#endif
	...
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_CS2), 1);
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_EB3), "eim_eb3");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_EB3), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_EB3), 0);
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_CS0), "eim_cs0");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_CS0), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_CS0), 1);

	/* USB2 related gpio */
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_CS1), "eim_cs1");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_CS1), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_CS1), 1);
	...
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_EB2), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_EB2), 0);
	...
	/* OTG related gpio */
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_CS3), "eim_cs3");
	gpio_direction_input(IOMUX_TO_GPIO(MX51_PIN_EIM_CS3));
	gpio_request(IOMUX_TO_GPIO(MX51_PIN_EIM_CS4), "eim_cs4");
	gpio_direction_output(IOMUX_TO_GPIO(MX51_PIN_EIM_CS4), 0);
	gpio_set_value(IOMUX_TO_GPIO(MX51_PIN_EIM_CS4), 1);	//gary modify for otg gadget from 1 to 0 20100608

	//gary add for d902 for power enable 20100630
	/* Camera low power */
