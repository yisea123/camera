...
#define VER_MAJOR   1
#define VER_MINOR1  0
#define VER_MINOR2  08
#define DATE_YEAR   2019
#define DATE_MONTH  04
#define DATE_DAY    09
...
int32_t  MS41909_Init(struct ms41909_ops *ops)
{
    ...
    MS41909_SetFrequency(DEFAULT_VD_FREQUENCY);
...
* Description:  设置脉冲周期
***************************************************************************************************/
int32_t MS41909_SetFrequency(uint8_t freq)
{
    if(freq == 0)
        return 1;
    ms41909_status.vd_frequency = freq;
    ms41909_status.period = 27000000u / 24 / ms41909_status.vd_frequency;
    return 0;
}
