...
struct camera_operations
{
    ...
    /* 曝光 */
    int32_t (*ctl_ae_mode)(uint8_t);
    int32_t (*ctl_shutter)(uint8_t);
    int32_t (*ctl_shutter_direct)(uint8_t);
    int32_t (*ctl_slow_shutter)(uint8_t);
    int32_t (*ctl_iris)(uint8_t);
    int32_t (*ctl_iris_direct)(uint8_t);
    int32_t (*ctl_gain)(uint8_t);
    int32_t (*ctl_gain_direct)(uint8_t);
    int32_t (*ctl_bright)(uint8_t);
    int32_t (*ctl_bright_direct)(uint8_t);
    int32_t (*inq_ae_mode)(uint8_t*);
    int32_t (*inq_shutter)(uint8_t*);
    int32_t (*inq_slow_shutter)(uint8_t*);
    int32_t (*inq_iris)(uint8_t*);
    int32_t (*inq_gain)(uint8_t*);
